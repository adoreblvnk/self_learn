...
int main() {
    ...
    // NOTE: braced initialisation forces the data to conform to the type, & throws an error if not. NOTE: assignment &
    // functional initialisation attempts to convert the data, which can cause unforeseen errors later on.
